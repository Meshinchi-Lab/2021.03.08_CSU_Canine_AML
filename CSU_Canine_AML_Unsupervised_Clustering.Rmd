...
obj <- seqGlue::calc_dispersion(as.matrix(CPM), removeOutliers = TRUE) #removes outlier genes/transcripts based on cooks D
sel_genes <- seqGlue::get_selected_genes(seqGlue::select_genes(obj, top_n=NULL))

length(sel_genes) #4131
# write.csv(sel_genes, "csu_selected_genes_10.28.2021.csv", row.names = FALSE)
```
